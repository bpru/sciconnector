				...
				<div className="col-md-12">
					<div className="card card-body bg-info text-white mb-3">
						...
						<div className="text-center">
							...
							<p>
								{isEmpty(profile.user.website)? null : (
									<a className="text-white p-2" href={profile.user.website} target="_blank">
										<i className="fas fa-globe fa-2x"></i>
									</a>
								)}

								{isEmpty(this.props.social && profile.social.twitter)? null : (
									<a className="text-white p-2" href={profile.social.twitter} target="_blank">
										<i className="fab fa-twitter  fa-2x"></i>
									</a>
								)}

								{isEmpty(this.props.social && profile.social.facebook)? null : (
									<a className="text-white p-2" href={profile.social.facebook} target="_blank">
										<i className="fab fa-facebook  fa-2x"></i>
									</a>
								)}

								{isEmpty(this.props.social && profile.social.youtube)? null : (
									<a className="text-white p-2" href={profile.social.youtube} target="_blank">
										<i className="fab fa-youtube  fa-2x"></i>
									</a>
								)}

								{isEmpty(this.props.social && profile.social.instagram)? null : (
									<a className="text-white p-2" href={profile.social.instagram} target="_blank">
										<i className="fab fa-instagram  fa-2x"></i>
									</a>
								)}

								{isEmpty(this.props.social && profile.social.linkedin)? null : (
